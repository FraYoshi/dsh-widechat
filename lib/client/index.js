...
function WideChatRow({ scope, t }) {
	...
	const userBubblePct = clampNumber(readField(section, USER_BUBBLE_PCT_FIELD, DEFAULTS[USER_BUBBLE_PCT_FIELD]), 30, 100, DEFAULTS[USER_BUBBLE_PCT_FIELD]);
	...
	const setUserBubble = (0, react.useCallback)((next) => {
		scope.set(USER_BUBBLE_PCT_FIELD, next);
	}, [scope]);
